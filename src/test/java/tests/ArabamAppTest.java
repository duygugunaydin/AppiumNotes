...
public class ArabamAppTest {
    ...
    public void arabamTest() throws InterruptedException {
        ...
        action.press(PointOption.point(543,2200))
                .waitAction(WaitOptions.waitOptions(Duration.ofMillis(500)))
                .moveTo(PointOption.point(537,100))
                .release()
                .perform();
      ...
      */
        ...
        // Versiyon secimi yapalim (Bu islemi koordinatla secim yapıyoruz)
        Thread.sleep(1000);
        action.press(PointOption.point(453,1850)).release().perform(); //490,1850
